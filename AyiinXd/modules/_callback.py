...
logoyins = random.choice(
        [
            ...
            "https://telegra.ph/file/7056a6787fca2795f2574.jpg",
            "https://telegra.ph/file/7056a6787fca2795f2574.jpg",
        ]
)
main_help_button = [
    [
        Button.inline("Mᴏᴅᴜʟᴇs", data="reopen"),
        Button.inline("Mᴇɴᴜ Vᴄ", data="inline_yins"),
    ],
    [
        Button.inline("Tᴏᴏʟs Oᴡɴᴇʀ", data="yins_langs"),
        Button.url("Sᴇᴛᴛɪɴɢ", url=f"t.me/{var.BOT_USERNAME}?start="),
    ],
...
async def on_plug_in_callback_query_handler(event):
    ...
    if event.query.user_id == uid or event.query.user_id in var.SUDO_USERS:
        ...
        text = f"**✨ Wᴀʏ-Usᴇʀʙᴏᴛ Iɴ Lɪɴᴇ Mᴇɴᴜ ✨**\n\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
        await event.edit(
            text,
            file=logoyins,
            buttons=buttons,
...
async def inline_handler(event):
    ...
    if event.query.user_id == uid and query.startswith(
        ...
        result = builder.article(
            ...
            url="https://t.me/WaySupp",
            thumb=InputWebDocument(
                var.INLINE_PIC,
                0,
                "image/jpeg",
                []),
            text="**Way-Userbot**\n➖➖➖➖➖➖➖➖➖➖\n✧  **ʀᴇᴘᴏ :** [WayDev](https://t.me/WayDevs)\n✧ **sᴜᴘᴘᴏʀᴛ :** @WaySupp\n✧ **ᴄʜᴀɴɴᴇʟ :** [Way-Userbot](https://t.me/WayDevInfo)\n➖➖➖➖➖➖➖➖➖➖",
            buttons=[
                [
                    custom.Button.url(
                        "ɢʀᴏᴜᴘ",
...
""",
                            buttons=[
                                [
                                    Button.inline("Vᴄ Pʟᴜɢɪɴ",
                                                data="vcplugin"),
                                    Button.inline("Vᴄ Tᴏᴏʟs",
                                                data="vctools")],
